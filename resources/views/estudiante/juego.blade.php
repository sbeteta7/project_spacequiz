...
<body>
    ...
    <div class="container-fluid" style="background-image:url(images/cielo.jpg) ">
        ...
        <div style="height: 100vh; display: flex;flex-direction: column;" class="px-5">
            <!-- Estableciendo diseño de la barra superior con avance de las preguntas -->
            <div style="background-color: rgb(19, 19, 19);display: flex;" class="rounded-5">
                ...
                <div style="display: flex; flex-grow: 8;flex-direction: column;">
                    ...
                    <div style="width: 100%;display: flex;justify-content: center;align-self: center;align-items: center;"
                        class="">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <form action="{{ route('calcular_puntaje') }}" method="POST" id="form_juego">
                            ...
                            <div class=" carousel-item @if ($index === 0) active @endif">
                                    ...
                                    <div style="display: flex;padding:50px">
                                        ...
                                        <div
                                            ...
                                            @foreach ($pregunta as $texto_pregunta => $respuesta)
                                                ...
                                                <div style="font-size: 3vw;" class="text-center text-dark h1 fw-bold">
                                                    {{ $texto_pregunta }}</div>
                                ...
                                <div style="background-color:white; display: flex;flex-direction: column;height: 50%;">
                                    ...
                                    <div style="display: flex; justify-content: center;height: 88%;">
                                        ...
                                        <div
                                            style="display: flex;flex-direction: column;justify-content:space-evenly;width: 70%;">
                                            ...
                                            @foreach ($respuesta as $texto_respuesta => $estado)
                                                <div class="form-check" style="padding: 0px 100px 0px 100px">
                                                    ...
                                                    <input class="form-check-input" type="radio" name="respuestas[{{ $id_pregunta }}]"
                    ...
                    <div style="background-color: black;height: 5%;display: flex;justify-content:space-between;padding: 0 10% 0 10%;"
                        class="rounded">
                        <!--Pasar a siguiente pregunta-->
                        <a class="carousel-control-prev" href="#carousel" role="button" data-slide="prev">
                            <i class="fa-solid fa-caret-left" style="color: rgb(0, 0, 0);  font-size: 40px;"></i>
                        </a>
        
                        <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
                            <i class="fa-solid fa-caret-right" style="color: rgb(0, 0, 0);font-size: 40px;"></i>
                        </a>
